...
import { LiaBedSolid, LiaStarSolid, LiaBathSolid, LiaRulerCombinedSolid } from "react-icons/lia"
...
export function Properties() {
    ...
    return (
        <Transition className="px-4 my-8 md:py-32 md:px-40">
            <div id="properties" className="grid grid-cols-2 gap-4 md:grid-cols-4">
